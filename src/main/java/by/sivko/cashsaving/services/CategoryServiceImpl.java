...
public class CategoryServiceImpl implements CategoryService {
    ...
    public Category addCategory(Category category) {
        ...
        logger.debug(String.format("Add category with %d", category.getId()));
        return category;
    }
    ...
    public Category removeCategory(Category category) {
        ...
        logger.debug(String.format("Delete category with %d", category.getId()));
        return category;
    }
    ...
    public Category updateCategory(Category category) {
        ...
        logger.debug(String.format("Update category with %d", category.getId()));
        return category;
    }
    ...
    public Category getCategoryById(Long id) throws NotFoundEntityException {
        ...
        logger.debug(String.format("Get category with %d", id));
        return category;
    }
    ...
    public Category removeCategoryById(Long id) throws NotFoundEntityException {
        ...
        logger.debug(String.format("Delete category with %d", id));
        return category;
    }
    ...
    public List<Category> getAllCategoriesByUserId(Long userId) {
        ...
        logger.debug(String.format("Get all categories by userId=[%d]", userId));
        return categoryList;
    }
    ...
    public List<Category> getAllCategoriesByUserIdAndPartOfName(Long userId, String pathOfName) {
        ...
        logger.debug(String.format("Get all categories by userId=[%d] and pathOfName=[%s]", userId, pathOfName));
        return categoryList;
    }
